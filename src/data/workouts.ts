...
export const SAMPLE_WORKOUTS: Workout[] = [
  {
    ...
    movements: [
      ...
      { movementId: 'thruster', reps: 15, loadKg: 43.1 },
      { movementId: 'pull-up', reps: 15 },
      { movementId: 'thruster', reps: 9, loadKg: 43.1 },
  ...
  },
  {
    ...
    name: 'Murph',
    workoutType: 'ForTime',
    description: '1 mile Run, 100 Pull-Ups, 200 Push-Ups, 300 Air Squats, 1 mile Run (with 20 lb vest)',
    weightVestKg: 9.07,
    segments: [
      {
        type: 'ForTime',
